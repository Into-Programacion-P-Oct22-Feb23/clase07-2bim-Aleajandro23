...
public class Ejemplo051 {
    ...
    public static void main(String[] args) {
        boolean bandera = true;           // repita antes del try
        while (bandera) {
            try {
               ...
               // bandera = false;
            } catch (InputMismatchException inputMismatchException) { // PARA OTRA COSA QUE NO SEA INT

                System.out.printf("Existe un error de tipo %s\n",
                        inputMismatchException);
            } catch (ArithmeticException arithmeticException) { // CUADNO SE DIVIDE PARA 0
